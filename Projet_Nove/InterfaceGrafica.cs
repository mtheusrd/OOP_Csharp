...
namespace Projet_Nove
{
    internal class InterfaceGrafica
    {
        ...
        public Resultado_e PegaString(ref string minhaString, string mensagem)
        {
            ...
            // Projetos criados anteriormente...
            Resultado_e retorno;
            Console.WriteLine(mensagem);
        ...
        public void ImprimeDadosNaTela(List<CadastroPessoa> pListasDePessoas)
        {
            foreach (CadastroPessoa pessoa in pListasDePessoas)
            {
        ...
        public void IniciaInterface()
        {
            ...
            do
            {
                Console.WriteLine("Seja bem vindo ao Sistema de Cadastro de Clientes");
                Console.WriteLine("==================================================");
                Console.WriteLine("Aplicação desenvolvida 2023");
                ...
                //Num.Contribuinte(Novo)
                {
                    ...
                    default:
                        ...
                        // [USERID]	- Utilizador do ERP associado ao vendedor
                }
